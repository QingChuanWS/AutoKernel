...
int main(int argc, char* argv[])
{
    ...
    switch(select_num)
    {
        ...
        case 4:
            ...
            break;
        case 5:
            benchmark_graph(&opt, "resnet18",         "/workspace/Tengine/benchmark/models/resnet18_benchmark.tmfile",           224, 224, 3, 1);
            break;
        case 6:
            benchmark_graph(&opt, "resnet50",         "/workspace/Tengine/benchmark/models/resnet50_benchmark.tmfile",           224, 224, 3, 1);
            break;
        case 7:
            benchmark_graph(&opt, "googlenet",        "/workspace/Tengine/benchmark/models/googlenet_benchmark.tmfile",          224, 224, 3, 1);
            break;
        case 8:
            benchmark_graph(&opt, "inceptionv3",      "/workspace/Tengine/benchmark/models/inception_v3_benchmark.tmfile",       299, 299, 3, 1);
            break;
        case 9:
            benchmark_graph(&opt, "vgg16",            "/workspace/Tengine/benchmark/models/vgg16_benchmark.tmfile",              224, 224, 3, 1);
            break;
        case 10:
            benchmark_graph(&opt, "mssd",             "/workspace/Tengine/benchmark/models/mssd_benchmark.tmfile",               300, 300, 3, 1);
            break;
        case 11:
            benchmark_graph(&opt, "retinaface",       "/workspace/Tengine/benchmark/models/retinaface_benchmark.tmfile",         320, 240, 3, 1);
            break;
        case 12:
            benchmark_graph(&opt, "yolov3_tiny",      "/workspace/Tengine/benchmark/models/yolov3_tiny_benchmark.tmfile",        416, 416, 3, 1);
            break;
        case 13:
            benchmark_graph(&opt, "mobilefacenets",   "/workspace/Tengine/benchmark/models/mobilefacenets_benchmark.tmfile",     112, 112, 3, 1);
            break;
        default:
            benchmark_graph(&opt, "squeezenet_v1.1",  "/workspace/Tengine/benchmark/models/squeezenet_v1.1_benchmark.tmfile",    227, 227, 3, 1);
//            benchmark_graph(&opt, "mobilenetv1",      "/workspace/Tengine/benchmark/models/mobilenet_benchmark.tmfile",          224, 224, 3, 1);
